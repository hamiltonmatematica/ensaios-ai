...
export const KPI_CATALOG: KpiDef[] = [
    ...
    { id: "all_conversions", metricKey: "all_conversions", icon: Target, color: "green", subMetric: "cpa_all_conversions", contexts: ["dashboard", "account", "campaign", "adset", "ad"] },
    { id: "view_through_conversions", metricKey: "view_through_conversions", icon: Eye, color: "purple", contexts: ["account", "campaign", "adset", "ad"] },
    { id: "interactions", metricKey: "interactions", icon: Activity, color: "yellow", contexts: ["account", "campaign", "adset", "ad"] },
