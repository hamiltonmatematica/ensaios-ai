...
function SignInContent() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Se redirect: true, o next-auth cuida do redirecionamento
            // Se houver erro, ele geralmente redireciona de volta com ?error=...
            // Mas podemos cair aqui se redirect: false
        } catch (error) {
            console.error(error)
    ...
    return (
        <div className="w-full max-w-md p-6 bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl animate-[scaleIn_0.2s_ease-out]">
            ...
            {mode === "login" && (
                <>
                    ...
                    <button
                        ...
                        className="w-full py-3 bg-white hover:bg-gray-100 text-gray-900 font-medium rounded-lg flex items-center justify-center gap-3 transition-colors"
                    >
